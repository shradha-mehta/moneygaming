package com.gameaccount.qa.moneygaming.utility;
...
public class Utility extends BasePage {
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/com/gameaccount/qa/moneygaming/screenshot/" + screenshotName + dateName + ".png";
